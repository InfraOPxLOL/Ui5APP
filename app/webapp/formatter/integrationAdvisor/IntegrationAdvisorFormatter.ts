...
/**
 * Binding-facing formatter surface for the Integration Advisor module views. Delegates to the centralized
 ...
 */
export default class IntegrationAdvisorFormatter {
